...
export default class Formfield extends ChildModifier {
    render(){
    ...
    cloneChild(child, key){
        ...
        if(this.props._formModel)newProps._formModel = this.props._formModel;
        if(this.props._formErrors)newProps._formErrors = this.props._formErrors;
        if(this.props._formErrorMessages)newProps._formErrorMessages = this.props._formErrorMessages;
        newProps.ref = key;
        newProps.key = key;
        if(child.props.onSetValue === undefined)newProps.onSetValue = this.props.onSetValue;
        if(child.props.value === undefined && this.props._formModel)newProps.value = this.props._formModel[child.props.name];
